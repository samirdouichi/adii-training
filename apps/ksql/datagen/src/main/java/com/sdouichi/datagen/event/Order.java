...
public class Order extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  /** Order's items */
  private java.util.List<com.sdouichi.datagen.event.OrderLine> order_lines;
   ...
   */
  public Order(java.lang.Long restaurant_id, java.lang.CharSequence order_id, java.lang.Double lat, java.lang.Double lon, java.lang.Long created_at, java.util.List<com.sdouichi.datagen.event.OrderLine> order_lines) {
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: order_lines = (java.util.List<com.sdouichi.datagen.event.OrderLine>)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public java.util.List<com.sdouichi.datagen.event.OrderLine> getOrderLines() {
    return order_lines;
  }
   ...
   * @param value the value to set.
   */
  public void setOrderLines(java.util.List<com.sdouichi.datagen.event.OrderLine> value) {
   ...
   */
  public static com.sdouichi.datagen.event.Order.Builder newBuilder() {
    return new com.sdouichi.datagen.event.Order.Builder();
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.sdouichi.datagen.event.Order.Builder newBuilder(com.sdouichi.datagen.event.Order.Builder other) {
    if (other == null) {
      return new com.sdouichi.datagen.event.Order.Builder();
    } else {
      return new com.sdouichi.datagen.event.Order.Builder(other);
    }
  }
   ...
   * @return A new Order RecordBuilder
   */
  public static com.sdouichi.datagen.event.Order.Builder newBuilder(com.sdouichi.datagen.event.Order other) {
    if (other == null) {
      return new com.sdouichi.datagen.event.Order.Builder();
    } else {
      return new com.sdouichi.datagen.event.Order.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Order>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.sdouichi.datagen.event.Order.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.sdouichi.datagen.event.Order other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.restaurant_id)) {
        this.restaurant_id = data().deepCopy(fields()[0].schema(), other.restaurant_id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setRestaurantId(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearRestaurantId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setOrderId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearOrderId() {
      order_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setLat(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearLat() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setLon(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearLon() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setCreatedAt(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder setOrderLines(java.util.List<com.sdouichi.datagen.event.OrderLine> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.sdouichi.datagen.event.Order.Builder clearOrderLines() {
      order_lines = null;
    ...
    public Order build() {
      try {
        ...
        record.order_lines = fieldSetFlags()[5] ? this.order_lines : (java.util.List<com.sdouichi.datagen.event.OrderLine>) defaultValue(fields()[5]);
        return record;
    ...
    throws java.io.IOException
  {
    ...
    long actualSize0 = 0;
    for (com.sdouichi.datagen.event.OrderLine e0: this.order_lines) {
      actualSize0++;
      out.startItem();
      e0.customEncode(out);
    }
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      ...
      java.util.List<com.sdouichi.datagen.event.OrderLine> a0 = this.order_lines;
      if (a0 == null) {
        a0 = new SpecificData.Array<com.sdouichi.datagen.event.OrderLine>((int)size0, SCHEMA$.getField("order_lines").schema());
        this.order_lines = a0;
      } else a0.clear();
      SpecificData.Array<com.sdouichi.datagen.event.OrderLine> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<com.sdouichi.datagen.event.OrderLine>)a0 : null);
      for ( ; 0 < size0; size0 = in.arrayNext()) {
        for ( ; size0 != 0; size0--) {
          com.sdouichi.datagen.event.OrderLine e0 = (ga0 != null ? ga0.peek() : null);
          if (e0 == null) {
            e0 = new com.sdouichi.datagen.event.OrderLine();
          }
          e0.customDecode(in);
          a0.add(e0);
        }
